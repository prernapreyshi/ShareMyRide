  ...
  return (
    <FormControl isRequired>
      ...
      <Box position="relative">
        <Input value={value} onChange={handleChange} placeholder={`Enter ${label.toLowerCase()}`} autoComplete="off" />
...
const RideRequestForm = () => {
  ...
  return (
    <Box maxW="md" mx="auto" mt={10} p={6} borderWidth="1px" borderRadius="md" boxShadow="lg">
